...
def main():
    ...
    # 배팅 명령어 핸들러
    application.add_handler(CommandHandler("플레이어", BotHandler.player_bet_command))
    application.add_handler(CommandHandler("뱅커", BotHandler.banker_bet_command))
    application.add_handler(CommandHandler("뱅", BotHandler.banker_bet_command))  # 줄임말
    application.add_handler(CommandHandler("무승부", BotHandler.tie_bet_command))
    application.add_handler(CommandHandler("무", BotHandler.tie_bet_command))  # 줄임말
